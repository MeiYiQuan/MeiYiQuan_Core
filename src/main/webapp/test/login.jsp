...
<body>
	...
	<!-- 测试登录 -->
	<input type="text" id="url"   value="http://127.0.0.1:8081/salon-art-circle/user/login.do" size=70> <br>
	<input type="text" id="param" value='{"phone":"17710663181","password":"123456","equi_type":"0"}'  size=70>
