...
<body>
	...
	<!-- 测试登录 -->
	<input type="text" id="url"   value="http://127.0.0.1:8080/salon-art-circle/user/myCollectEdit.do" size=70> <br>
	<input type="text" id="param" value='{"userid":"40287381585e0c3401585e0edb4f0001","collectTypes":"1","collectTypeIds":"1"}'  size=70>
