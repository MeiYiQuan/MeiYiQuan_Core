...
<body>
	...
	<!-- 测试登录 -->
	<input type="text" id="url"   value="http://127.0.0.1:8080/salon-art-circle/user/offlineActivity.do" size=70> <br>
		<input type="button" onclick="play()" value="全国"/> <br>
	<input type="button" onclick="order()" value="地方"/> <br>
	<input type="button" onclick="comment()" value="已结束"/> <br>
