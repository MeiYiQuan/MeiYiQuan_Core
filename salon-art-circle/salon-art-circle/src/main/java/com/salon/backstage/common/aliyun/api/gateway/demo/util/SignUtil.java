 ...
 * under the License.
 */
package com.salon.backstage.common.aliyun.api.gateway.demo.util;
...
import com.salon.backstage.common.aliyun.api.gateway.demo.constant.HttpHeader;
import com.salon.backstage.common.aliyun.api.gateway.demo.constant.SystemHeader;
...
public class SignUtil {
     ...
     * @return 签名后的字符串
     */
    public static String sign(String method, String url, Map<String, String> headers, @SuppressWarnings("rawtypes") Map formParamMap, String secret,
     ...
     * @return 签名字符串
     */
    private static String buildStringToSign(Map<String, String> headers, String url, @SuppressWarnings("rawtypes") Map formParamMap, String method,
                                            List<String> signHeaderPrefixList) {
