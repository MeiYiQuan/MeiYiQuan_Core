...
<body>
	...
	注册访问路径:<input type="text" id="forgetPassword_url"   value="http://127.0.0.1:8081/salon-art-circle/user/forgetPassword.do" size=70> <br>
	...
	密码:<input type="text" id="firstPassword" > <br>
	再次输入密码:<input type="text" id="secondPassword" > <br>
	...
	<script type="text/javascript">
		...
		function testSend(){
			...
			var data0 = '{"phone":"'+$("#phone").val()+'","whoNeedIdenCode":"1"}';
			$.ajax({
	                    type: "post",
	                    dataType:"text",
	                    url:url_val,
		...
		function testEdit(){
			var url_val = $("#forgetPassword_url").val();
			var data1 = '{"phone":"'+$("#phone").val()+'","firstPassword":"'+$("#firstPassword").val()+'","secondPassword":"'+$("#secondPassword").val()+'","idenCode":"'+$("#idenCode").val()+'"}'
			$.ajax({
	                    type: "post",
	                    dataType:"text",
	                    url:url_val,
