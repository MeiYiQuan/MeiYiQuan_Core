...
<body>
	...
	<input type="text" id="param" value='{"courseOrActivityId":"1","type":"1"}'  size=70> <br>
	...
	<input type="text" id = "videoId" value="1"> 视频ID<br>
	<input type="text" id = "price" value="1"> 价格<br>
	<input type="text" id="buyVideoUrl"   value="http://127.0.0.1:8081/salon-art-circle/video/teacherDetailBuyVideo.do" size=70> 课程详情页-评论信息<br>
	<input type="button" onclick="buyVideo()" value="购买视频"/> <br>
