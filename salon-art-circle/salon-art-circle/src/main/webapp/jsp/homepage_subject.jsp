...
<body>
	...
	<!-- 测试登录 -->
	<input type="text" id="url"   value="http://127.0.0.1:8081/salon-art-circle/homepage/subjectTotal.do" size=70> <br>
	<input type="text" id="pageNo" value="0"> <br>
	...
	<script type="text/javascript">
		...
		function testSend(){
			var url_val = $("#url").val();
	        var dataSend = '{"pageNo":"'+$("#pageNo").val()+'","pagesize":"'+$("#pagesize").val()+'"}'
			$.ajax({
	                    type: "post",
	                    dataType:"text",
	                    url:url_val,
